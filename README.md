# Vehicle-Tracker
Ever tried to track an object in a video, only to find out that the tracker to lose it the second it drives behind a tree or another car? It’s a common frustration in computer vision.
